...
Author: Luke van Boven
Email: L.vanBoven@umcutrecht.nl

## Installation

To install the propofol package use:
...
Other parts of the project (data cleaning) live in separate repositories and are **not** included here.
